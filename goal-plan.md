...
exit-fullscreen overlay, chart hover overlays, keyboard-shortcuts modal, map export/print controls, loading overlay,
settings modal icons, add-FIT-to-map control, marker-count selector, data-point filter icons, render-summary controls, map theme toggle,
