...
| `tests/unit/`               | Root-owned Vitest suites for tooling, runtime/preload boundaries, chart/map/menu/lifecycle/file/theming/rendering behavior, and shared UI behavior |
