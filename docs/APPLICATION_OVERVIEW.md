...
| `electron-app/tests/`       | App-coupled Vitest utility unit suites and strict regression suites                                                                                     |
| `tests/unit/`               | Root-owned Vitest suites for tooling, runtime/preload/main boundaries, chart/map/menu/lifecycle/file/theming/rendering behavior, and shared UI behavior |
