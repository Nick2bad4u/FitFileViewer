 ...
 * @param {number} [precision=2] - Decimal precision. Default is `2`
 *
 ...
 * @param {Object} [options={}] - Chart options. Default is `{}`
 *
 ...
 * @param {Object} [options={}] - Map configuration options. Default is `{}`
 *
...
const validation = validateInput(
 inputData,
 [validators.isRequired, validators.isObject, validators.hasProperty("data")],
 "inputData"
);
