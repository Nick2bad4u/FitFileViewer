...
export function createChangelogJobSummary(options) {
    return [
...
export function updateChangelogJobSummary(options) {
    fs.appendFileSync(
...
function printUsage() {
    console.log(`Usage: node scripts/update-changelog-job-summary.mjs [options]
