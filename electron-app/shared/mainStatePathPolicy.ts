{
    ...
    function isSafeMainStateOperationId(value: unknown): value is string {
    ...
    function isSafeMainStatePath(value: unknown): value is string {
    ...
    function validateMainStateOperationIdInput(value: unknown): string {
    ...
    function validateMainStatePathInput(
        value: unknown,
