...
type ChartConstructorMock = ReturnType<
    typeof vi.fn<(canvas: HTMLCanvasElement, config: ZoneChartConfig) => ZoneChartInstanceMock>
>;
...
let createChartCanvasMock: ReturnType<
    typeof vi.fn<() => HTMLCanvasElement>
>;
...
describe("renderZoneChart.js - Zone Chart Rendering Utility", () => {
    ...
    it("should warn and exit when container is invalid", () => {
        ...
        expect(getZoneChartGlobal()._chartjsInstances).toEqual([]);
    });
