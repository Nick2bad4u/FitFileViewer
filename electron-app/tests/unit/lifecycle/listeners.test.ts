...
describe("utils/app/lifecycle/listeners.js", () => {
  beforeEach(() => {
    ...
    Object.assign(window, { electronAPI: undefined, showFitData: undefined, ChartUpdater: undefined, renderChartJS: undefined });
  });
  ...
  function mount(openRecentReturn: string[] | null = null) {
    ...
    setupListeners({ openFileBtn, isOpeningFileRef, setLoading, showNotification, handleOpenFile, showUpdateNotification, showAboutModal });
