...
describe("convertTemperatureUnits.js - Temperature Unit Converter Utility", () => {
    ...
    describe("Input Validation", () => {
        it("should throw TypeError for null input", () => {
            expect(() => convertTemperatureUnits(null as any, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received object"
            );
        });

        it("should throw TypeError for undefined input", () => {
            expect(() => convertTemperatureUnits(undefined as any, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received undefined"
            );
        });

        it("should throw TypeError for string input", () => {
            expect(() => convertTemperatureUnits("25" as any, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received string"
            );
        });

        it("should throw TypeError for boolean input", () => {
            expect(() => convertTemperatureUnits(true as any, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received boolean"
            );
        });

        it("should throw TypeError for object input", () => {
            expect(() => convertTemperatureUnits({} as any, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received object"
            );
        });
        ...
        it("should throw TypeError for NaN input", () => {
            expect(() => convertTemperatureUnits(NaN, TEMPERATURE_UNITS.FAHRENHEIT)).toThrow(
                "Expected celsius to be a number, received number"
            );
        });
    });
