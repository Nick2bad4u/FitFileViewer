...
describe("convertTemperatureUnits.js - Temperature Unit Converter Utility", () => {
    ...
    describe("Input Validation", () => {
        ...
        it("should throw TypeError for object input", () => {
            expect(() =>
                convertTemperatureUnits({} as any, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toThrow("Expected celsius to be a number, received object");
        });
    ...
    describe("Basic Conversions - Celsius to Fahrenheit", () => {
        it("should convert freezing point (0°C to 32°F)", () => {
            const result = convertTemperatureUnits(
                0,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
    ...
    describe("Basic Conversions - Celsius to Celsius", () => {
        it("should return same value for celsius to celsius", () => {
            ...
            expect(
                convertTemperatureUnits(100, TEMPERATURE_UNITS.CELSIUS)
            ).toBe(100);
        });

        it("should handle decimal values for celsius to celsius", () => {
            expect(
                convertTemperatureUnits(23.5, TEMPERATURE_UNITS.CELSIUS)
            ).toBe(23.5);
            expect(
                convertTemperatureUnits(-15.7, TEMPERATURE_UNITS.CELSIUS)
            ).toBe(-15.7);
        });
    });
    ...
    describe("Performance and Precision", () => {
        it("should be consistent across multiple calls", () => {
            ...
            const results = Array.from({ length: 100 }, () =>
                convertTemperatureUnits(testTemp, TEMPERATURE_UNITS.FAHRENHEIT)
            );
        ...
        it("should handle rapid successive conversions", () => {
            ...
            const results = testTemps.map((temp) =>
                convertTemperatureUnits(temp, TEMPERATURE_UNITS.FAHRENHEIT)
            );
        ...
        it("should maintain precision for weather temperatures", () => {
            ...
            expect(
                convertTemperatureUnits(15, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(59); // Cool day
            expect(
                convertTemperatureUnits(30, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(86); // Hot day
            expect(
                convertTemperatureUnits(-5, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(23); // Cold day
        });
    });
    ...
    describe("Real-world Usage Scenarios", () => {
        it("should convert body temperature correctly", () => {
            ...
            const normalTemp = convertTemperatureUnits(
                36.7,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
        ...
        it("should handle cooking temperatures", () => {
            // Oven temperatures
            expect(
                convertTemperatureUnits(180, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(356); // Common baking temp
            expect(
                convertTemperatureUnits(200, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(392); // High heat baking
            expect(
                convertTemperatureUnits(220, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(428); // Very high heat
        });

        it("should convert weather station data", () => {
            // Typical weather station readings
            const morningTemp = convertTemperatureUnits(
                12,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
            expect(morningTemp).toBeCloseTo(53.6, 1);

            const afternoonTemp = convertTemperatureUnits(
                28,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
        ...
        it("should handle fitness tracker temperature data", () => {
            ...
            const skinTemp = convertTemperatureUnits(
                32,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
            ...
            // Ambient temperature
            const ambientTemp = convertTemperatureUnits(
                22,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
        ...
        it("should convert scientific measurement data", () => {
            ...
            const labTemp = convertTemperatureUnits(
                23,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
            ...
            const calTemp = convertTemperatureUnits(
                20,
                TEMPERATURE_UNITS.FAHRENHEIT
            );
    ...
    describe("Constants Validation", () => {
        ...
        it("should use correct conversion factors internally", () => {
            ...
            expect(
                convertTemperatureUnits(1, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBeCloseTo(33.8, 1);
        });
    });
    ...
    describe("Conversion Accuracy", () => {
        ...
        it("should handle edge case measurements accurately", () => {
            ...
            // Room temperature
            expect(
                convertTemperatureUnits(20, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(68);

            // Body temperature
            expect(
                convertTemperatureUnits(37, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBeCloseTo(98.6, 1);
        });
    });
    ...
    describe("Mathematical Verification", () => {
        ...
        it("should handle negative temperatures correctly", () => {
            ...
            expect(
                convertTemperatureUnits(-10, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(14);
            expect(
                convertTemperatureUnits(-20, TEMPERATURE_UNITS.FAHRENHEIT)
            ).toBe(-4);
            ...
            ).toBe(-40); // Special case where C = F
        });
    });
});
