...
describe('chartStatusIndicator.js', () => {
  ...
  describe('updateAllChartStatusIndicators', () => {
    it('should update both status indicators when they exist', async () => {
      ...
      const { updateAllChartStatusIndicators } = await import('../../../../../utils/charts/components/chartStatusIndicator.js');
    ...
    it('should create global indicator if it does not exist', async () => {
      ...
      // Import the module after setting up the DOM
      const { updateAllChartStatusIndicators } = await import('../../../../../utils/charts/components/chartStatusIndicator.js');
      const { createGlobalChartStatusIndicator } = await import('../../../../../utils/charts/components/createGlobalChartStatusIndicator.js');
  ...
  describe('updateChartStatusIndicator', () => {
    it('should update a specific chart status indicator when provided', async () => {
      ...
      // Import the module
      const { updateChartStatusIndicator } = await import('../../../../../utils/charts/components/chartStatusIndicator.js');
      const { createChartStatusIndicator } = await import('../../../../../utils/charts/components/createChartStatusIndicator.js');
  ...
  describe('setupChartStatusUpdates', () => {
    it('should register all required event listeners', async () => {
      // Import the module
      const { setupChartStatusUpdates } = await import('../../../../../utils/charts/components/chartStatusIndicator.js');
    ...
    it('should handle event listener callbacks correctly', async () => {
      ...
      const storageHandlerCall = vi.mocked(window.addEventListener).mock.calls.find(
        call => call[0] === 'storage'
      );
      const fieldToggleHandlerCall = vi.mocked(window.addEventListener).mock.calls.find(
        call => call[0] === 'fieldToggleChanged'
      );
      const chartsRenderedHandlerCall = vi.mocked(document.addEventListener).mock.calls.find(
        call => call[0] === 'chartsRendered'
      );
