...
describe('updateActiveTab.js - Comprehensive Tests', () => {
    ...
    describe('updateActiveTab', () => {
        ...
        it('should handle tab IDs with special characters', () => {
            ...
            expect(mockSetState).toHaveBeenCalledWith('ui.activeTab', 'special-chars_123', { source: 'updateActiveTab' });
            ...
            expect(mockSetState).toHaveBeenCalledWith('ui.activeTab', 'tab_with_underscores', { source: 'updateActiveTab' });
        });
    ...
    describe('Performance Tests', () => {
        it('should handle large number of tab elements efficiently', () => {
            ...
            const tabsHtml = Array.from({ length: 1000 }, (_, i) =>
