...
describe('mainProcessStateManager.js - Comprehensive Coverage', () => {
    ...
    describe('Exported Module', () => {
        ...
        test('should maintain singleton behavior', async () => {
            const { mainProcessState: instance1 } = await import('../../../../../utils/state/integration/mainProcessStateManager.js');
            const { mainProcessState: instance2 } = await import('../../../../../utils/state/integration/mainProcessStateManager.js');
