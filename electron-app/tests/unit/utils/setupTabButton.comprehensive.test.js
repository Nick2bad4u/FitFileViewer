...
describe('setupTabButton.js - Comprehensive Bug Detection Test Suite', () => {
    ...
    describe('DOM Element Detection and Caching - Bug Testing', () => {
        it('should warn when element does not exist', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Button with id "non-existent-button" not found. Ensure the element exists in the DOM.');
        });
        ...
        it('BUG TEST: should handle cache staleness when element is removed from DOM', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Cached button with id "stale-test" is no longer in DOM. Refreshing cache.');
        ...
        it('BUG TEST: should handle case where cached element becomes disconnected but replacement fails', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Cached button with id "disconnect-test" is no longer in DOM. Refreshing cache.');
            expect(consoleWarnSpy).toHaveBeenCalledWith('Button with id "disconnect-test" not found after cache refresh.');
        });
    });
    ...
    describe('Cache Management - Memory Leak Bug Detection', () => {
        ...
        it('should clear cache and remove all handlers properly', () => {
            ...
            const buttons = ['clear-test-1', 'clear-test-2', 'clear-test-3'].map(id =>
    ...
    describe('Integration and Real-World Scenarios', () => {
        ...
        it('BUG TEST: should handle DOM mutations that affect cached elements', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Cached button with id "mutation-test" is no longer in DOM. Refreshing cache.');
        });
    ...
    describe('Error Resilience and Edge Cases', () => {
        it('should handle elements that become invalid after caching', () => {
            ...
            Object.defineProperty(button, 'addEventListener', {
                value: () => { throw new Error('addEventListener failed'); }
            });
