...
describe("formatHeight.js - Height Formatter Utility", () => {
    ...
    describe("Real-world Height Scenarios", () => {
        it("should format common adult heights correctly", () => {
            const commonHeights = [
                { meters: 1.6, expected: "1.60 m (5'3\")" },
                { meters: 1.65, expected: "1.65 m (5'5\")" },
                { meters: 1.7, expected: "1.70 m (5'7\")" },
                { meters: 1.75, expected: "1.75 m (5'9\")" },
                { meters: 1.8, expected: "1.80 m (5'11\")" },
        ...
        it("should format child heights", () => {
            expect(formatHeight(1.2)).toBe("1.20 m (3'11\")"); // Tall child
            expect(formatHeight(1.0)).toBe("1.00 m (3'3\")"); // Average child
            expect(formatHeight(0.8)).toBe("0.80 m (2'7\")"); // Young child
        });
