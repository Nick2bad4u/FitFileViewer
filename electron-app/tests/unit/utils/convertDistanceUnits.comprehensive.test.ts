...
describe('convertDistanceUnits.js - Distance Unit Converter Utility', () => {
  ...
  describe('Input Validation', () => {
    it('should throw TypeError for null input', () => {
      ...
      expect(() => convertDistanceUnits(null as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received object');
    });

    it('should throw TypeError for undefined input', () => {
      expect(() => convertDistanceUnits(undefined as any, DISTANCE_UNITS.KILOMETERS)).toThrow(TypeError);
      expect(() => convertDistanceUnits(undefined as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received undefined');
    });
    ...
    it('should throw TypeError for string input', () => {
      ...
      expect(() => convertDistanceUnits('1000' as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received string');
    });
    ...
    it('should throw TypeError for boolean input', () => {
      ...
      expect(() => convertDistanceUnits(true as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received boolean');
    });

    it('should throw TypeError for object input', () => {
      expect(() => convertDistanceUnits({} as any, DISTANCE_UNITS.KILOMETERS)).toThrow(TypeError);
      expect(() => convertDistanceUnits({} as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received object');
    });

    it('should throw TypeError for array input', () => {
      expect(() => convertDistanceUnits([1000] as any, DISTANCE_UNITS.KILOMETERS)).toThrow(TypeError);
      expect(() => convertDistanceUnits([1000] as any, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received object');
    });

    it('should throw TypeError for NaN input', () => {
      expect(() => convertDistanceUnits(NaN, DISTANCE_UNITS.KILOMETERS)).toThrow(TypeError);
      expect(() => convertDistanceUnits(NaN, DISTANCE_UNITS.KILOMETERS)).toThrow('Expected meters to be a number, received number');
    });
  ...
  describe('Error Handling', () => {
    it('should warn for unknown units and default to meters', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertDistanceUnits] Unknown unit 'unknown', defaulting to meters");
    });

    it('should handle empty string unit', () => {
      const result = convertDistanceUnits(1000, '' as any);
      expect(result).toBe(1000);
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertDistanceUnits] Unknown unit '', defaulting to meters");
    });

    it('should handle null unit', () => {
      const result = convertDistanceUnits(1000, null as any);
      expect(result).toBe(1000);
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertDistanceUnits] Unknown unit 'null', defaulting to meters");
    });

    it('should handle undefined unit', () => {
      const result = convertDistanceUnits(1000, undefined as any);
      expect(result).toBe(1000);
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertDistanceUnits] Unknown unit 'undefined', defaulting to meters");
    });
  });
