...
describe('Converter Utilities', () => {
  ...
  describe('convertTemperatureUnits', () => {
    ...
    it('should handle unknown units with warning and return original value', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertTemperatureUnits] Unknown unit 'kelvin', defaulting to celsius");
    });
  ...
  describe('convertTimeUnits', () => {
    ...
    it('should handle unknown units with warning and return original value', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith("[convertTimeUnits] Unknown unit 'days', defaulting to seconds");
    });
  ...
  describe('convertValueToUserUnits', () => {
    ...
    describe('error handling', () => {
      it('should handle non-numeric values gracefully', () => {
        ...
        expect(mockConsole.warn).toHaveBeenCalledWith("[convertValueToUserUnits] Invalid value for field 'distance':", 'not a number');
      });
      ...
      it('should handle NaN values gracefully', () => {
        ...
        expect(mockConsole.warn).toHaveBeenCalledWith("[convertValueToUserUnits] Invalid value for field 'distance':", NaN);
      });
