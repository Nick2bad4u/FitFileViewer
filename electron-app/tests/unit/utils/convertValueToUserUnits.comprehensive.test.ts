  ...
  describe('Input Validation', () => {
    it('should warn for null value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", null
      );
    });
    ...
    it('should warn for undefined value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", undefined
      );
    });
    ...
    it('should warn for string value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", '123'
      );
    });
    ...
    it('should warn for boolean value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", true
      );
    });
    ...
    it('should warn for NaN value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", NaN
      );
    });
    ...
    it('should warn for object value and return unchanged', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid value for field 'distance':", objValue
      );
    });
    ...
    it('should warn for null field and return value unchanged', () => {
      ...
      expect(result).toBe(1000);
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid field name:", null
      );
    });
    ...
    it('should warn for undefined field and return value unchanged', () => {
      ...
      expect(result).toBe(1000);
      expect(mockConsole.warn).toHaveBeenCalledWith(
        "[convertValueToUserUnits] Invalid field name:", undefined
      );
    });
  });
