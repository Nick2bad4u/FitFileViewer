  ...
  describe('logWithLevel.js - Structured Logging', () => {
    ...
    describe('Context Handling', () => {
      ...
      it('should log without context when undefined', () => {
        ...
        expect(mockConsole.info).toHaveBeenCalledWith('2023-01-01T12:00:00.000Z [FFV] Message with undefined context');
      });

      it('should log without context when empty object', () => {
        logWithLevel('info', 'Message with empty context', {});

        expect(mockConsole.info).toHaveBeenCalledWith('2023-01-01T12:00:00.000Z [FFV] Message with empty context');
      });
