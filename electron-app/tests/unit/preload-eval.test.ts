...
describe('preload.js - Script Evaluation Test', () => {
    ...
    beforeEach(() => {
        ...
        console.log('[TEST] Final contextBridge calls:', electronMock.contextBridge.exposeInMainWorld.mock.calls.length);
    });
    ...
    it('should execute the preload script and expose APIs', () => {
        ...
        console.log('[TEST] exposeInMainWorld calls:', exposeCalls.map((call: any) => call[0]));
    });
    ...
    it('should log initialization messages', () => {
        ...
        const hasPreloadLogs = logCalls.some((call: any) =>
            call[0] && call[0].includes('[preload.js]')
        );
