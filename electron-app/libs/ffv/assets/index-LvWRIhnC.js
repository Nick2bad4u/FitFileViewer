...
function jm(e, t, n, r, o) {
	switch (t) {
		...
		case 'gotpointercapture':
			return (
				(i = o.pointerId), xr.set(i, Kn(xr.get(i) || null, e, t, n, r, o)), !0
			);
	}
	return !1;
}
	...
	Ac(function () {
		...
		e: {
			...
			if (h !== void 0) {
				...
				for (var c = a, p; c !== null; ) {
					...
					if (
						(p.tag === 5 &&
							_ !== null &&
							((p = _),
							d !== null && ((_ = wr(c, d)), _ != null && S.push(Tr(c, _, p)))),
						x)
					)
						break;
					c = c.return;
				...
				0 < S.length &&
					((h = new g(h, y, null, n, m)), f.push({ event: h, listeners: S }));
			}
		}
		if (!(t & 7)) {
			e: {
	...
	function y(d, c, p, _) {
		...
		if (P === null) {
			for (; C < p.length; C++)
				(P = f(d, p[C], _)),
					P !== null &&
						((c = i(P, c, C)), T === null ? (k = P) : (T.sibling = P), (T = P));
			return G && Ft(d, C), k;
		}
	...
	function S(d, c, p, _) {
		...
		if (P === null) {
			for (; !A.done; C++, A = p.next())
				(A = f(d, A.value, _)),
					A !== null &&
						((c = i(A, c, C)), T === null ? (k = A) : (T.sibling = A), (T = A));
			return G && Ft(d, C), k;
		}
...
function Id(e, t, n) {
	return (
		(n = n != null ? n.concat([e]) : null), oi(4, 4, Pd.bind(null, t, e), n)
	);
}
function Hl() {}
function Ad(e, t) {
...
function Ld(e, t, n) {
	return Jt & 21
		? (Ve(n, t) || ((n = zc()), (Q.lanes |= n), (Zt |= n), (e.baseState = !0)),
		  t)
...
function va(e, t, n, r, o) {
	...
	if (((i = e.child), !(e.lanes & o))) {
		...
		if (
			((n = n.compare), (n = n !== null ? n : Cr), n(s, r) && e.ref === t.ref)
		)
			return at(e, t, o);
	}
	return (
...
function Fs(e, t, n, r, o, i) {
	...
	return (
		(t.flags |= 1),
		e !== null && s
			? ((t.child = jn(t, e.child, null, i)), (t.child = jn(t, null, l, i)))
			: fe(e, t, l, i),
			...
			return t.flags & 128
				...
				: ((r = r !== null),
				  r !== (e !== null && e.memoizedState !== null) &&
						...
						((t.child.flags |= 8192),
						t.mode & 1 &&
							(e === null || H.current & 1 ? ee === 0 && (ee = 3) : ql())),
				  t.updateQueue !== null && (t.flags |= 4),
				  ae(t),
				  null);
		case 4:
			return (
				Mn(), $s(e, t), e === null && Nr(t.stateNode.containerInfo), ae(t), null
			);
		case 10:
...
function Xd(e) {
	...
	t !== null && ((e.alternate = null), Xd(t)),
		...
		e.tag === 5 &&
			((t = e.stateNode),
			t !== null &&
				(delete t[Ke], delete t[Rr], delete t[Is], delete t[Rh], delete t[Ph])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function Zd(e, t, n) {
	...
	switch (n.tag) {
		...
		case 22:
			n.mode & 1
				? ((ce = (r = ce) || n.memoizedState !== null), pt(e, t, n), (ce = r))
				: pt(e, t, n);
			break;
		default:
			pt(e, t, n);
		...
		case 5:
			...
			if (r & 4 && ((o = e.stateNode), o != null)) {
				...
				if (((e.updateQueue = null), u !== null))
					try {
						l === 'input' && i.type === 'radio' && i.name != null && _c(o, i),
							gs(l, s);
						var a = gs(l, i);
...
function ef(e, t, n) {
	for (var r = (e.mode & 1) !== 0; R !== null; ) {
		...
		if (o.tag === 22 && r) {
			...
			o.subtreeFlags & 8772 && i !== null ? ((i.return = o), (R = i)) : Ca(e);
	}
}
function Ca(e) {
	for (; R !== null; ) {
...
function tf(e, t) {
	...
	if (t !== 0) {
		if (
			(t === 2 && ((o = _s(e)), o !== 0 && ((r = o), (t = Ys(e, o)))), t === 1)
		)
		...
		if (t === 6) wt(e, r);
			...
			switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						(wt(e, r), (r & 130023424) === r && ((t = Xl + 500 - X()), 10 < t))
					) {
						if (Po(e, 0) !== 0) break;
	...
	if (xt !== null) {
		...
		try {
			if (((Oe.transition = null), (z = 16 > e ? 16 : e), xt === null))
				...
				if (
					((M = o), Dt(), Xe && typeof Xe.onPostCommitFiberRoot == 'function')
				)
					try {
...
function Eo(e, t, n, r, o, i) {
	...
	if (((r = e), typeof e == 'function')) eu(e) && (s = 1);
		...
		e: switch (e) {
			...
			case ss:
				return (
					(e = Ae(12, n, t, o | 2)), (e.elementType = ss), (e.lanes = i), e
				);
			case ls:
	...
	return (
		(t = Ae(s, n, t, o)), (t.elementType = e), (t.type = r), (t.lanes = i), t
	);
}
function Ht(e, t, n, r) {
	...
	switch (e.tag) {
		case 3:
			...
			if (t.current.memoizedState.isDehydrated) {
				...
				n !== 0 &&
					(El(t, n | 1), _e(t, X()), !(M & 6) && ((bn = X() + 500), Dt()));
			}
			break;
		case 13:
			qt(function () {
...
function gf(e) {
	...
	if (hg(e)) {
		...
		return (
			typeof CustomEvent < 'u' && mi(e, CustomEvent) && (t.detail = e.detail), t
		);
	} else return e;
}
function Da(e) {
...
class du {
	...
	captureException(t, n) {
		...
		if (!this._client)
			return (
				Pn.warn('No client configured on scope - will not capture exception!'),
				r
			);
	...
	captureMessage(t, n, r) {
		...
		if (!this._client)
			return (
				Pn.warn('No client configured on scope - will not capture message!'), o
			);
		const i = new Error(t);
		return (
...
class Fy {
	constructor(t, n = 1e4) {
			...
			this.batchSend(this.queue)
				.then(() => {
					this.queue.splice(0, t),
						this.handle && (clearTimeout(this.handle), (this.handle = null));
				})
				.catch((n) => {
		...
		ki(this, 'send', (t) => {
			this.queue.push(t),
				this.handle || (this.handle = setTimeout(this.flush, this.delay));
		});
		(this.batchSend = t),
			(this.queue = []),
			(this.handle = null),
	...
	const a = e + 'CollectionItemSlot',
		...
		f = gt.forwardRef((g, y) => {
			...
			return (
				gt.useEffect(
					() => (
						_.itemMap.set(c, { ref: c, ...d }), () => void _.itemMap.delete(c)
					),
				),
...
var j0 = w.forwardRef((e, t) => {
		...
		return (
			w.useEffect(() => {
				const C = h.current;
				if (C)
					return C.addEventListener(rs, p), () => C.removeEventListener(rs, p);
			}, [p]),
			v.jsx(O0, {
				scope: n,
				orientation: r,
