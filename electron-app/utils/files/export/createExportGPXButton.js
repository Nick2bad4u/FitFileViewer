...
export function createExportGPXButton() {
    ...
    exportBtn.addEventListener('click', () => {
        if (!globalThis.globalData || !globalThis.globalData.recordMesgs || !Array.isArray(globalThis.globalData.recordMesgs)) {
            return;
        }
        const coords = globalThis.globalData.recordMesgs
            ...
            SEMICIRCLE_DIVISOR = 2_147_483_647; // 2 ** 31 - 1, per FIT protocol
