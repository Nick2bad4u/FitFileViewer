 ...
 *   handling
 *
 * @file Distance unit conversion utility for FitFileViewer
 *
 *   Provides functions for converting distances between different units (meters,
 *   kilometers, feet, miles) with consistent error handling and validation.
 *
