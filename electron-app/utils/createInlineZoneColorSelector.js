...
function createZoneColorItem(field, zone, zoneIndex, getCurrentScheme) {
    ...
    colorInput.addEventListener("change", (e) => {
        ...
        try {
            ...
            // Call renderChartJS directly (same as metrics color picker)
...
function createColorSchemeSelector(
    ...
    select.addEventListener("change", (e) => {
        ...
        try {
            ...
            if (typeof window.renderChartJS === "function") window.renderChartJS();
            else if (typeof renderChartJS === "function") renderChartJS();
        } catch (error) {
