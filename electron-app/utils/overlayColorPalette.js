...
export const overlayColorPalette = (function shuffleAndFilter(array) {
    ...
    "#00adad", "#bf3b00", "#0028bf", "#960f51", "#00bf7e", "#83b200",
    "#e70000", "#0054bf", "#9b0025", "#1100be", "#ac9201", "#0091bf",
    "#ff1989", "#004cff", "#ff473b", "#0029ff", "#ff4051", "#00e8bb",
    "#ff1a00", "#0015ff", "#8900fc", "#007f54", "#4c7700", "#006efb",
    "#e21649", "#00c2ff",
]);
