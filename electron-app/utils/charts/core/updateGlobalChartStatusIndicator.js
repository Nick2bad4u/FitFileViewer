/**
 * @file Global chart status indicator updater for FitFileViewer
 *
 ...
 *
 * @returns {Element} Container element (preferred container or body as
 *   fallback)
 */
function findStatusContainer() {
    return (
        document.getElementById(ELEMENT_IDS.STATUS_CONTAINER) || document.body
    );
}
