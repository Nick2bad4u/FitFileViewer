function registerSharedConfigurationLoader(chartGlobal, loadSharedConfiguration) {
 ...
 */
export function registerChartStartup({ chartActions, chartGlobal, loadSharedConfiguration, setGlobalChartActions, }) {
