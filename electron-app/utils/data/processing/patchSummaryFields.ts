...
/**
 * Options controlling summary field patching.
 */
export interface PatchSummaryFieldsOptions {
    preserveOriginal?: boolean;
    skipValidation?: boolean;
}

/**
 * Loosely shaped raw FIT summary data.
 */
 ...
 */
export function patchSummaryFields(
    obj: SummaryRecord,
    options: PatchSummaryFieldsOptions = {}
): SummaryRecord {
    const config = {
...
function formatArray(
    ...
    digits = PATCH_CONSTANTS.DECIMAL_PLACES.DEFAULT
): string {
...
function patchArrays(obj: SummaryRecord): void {
    const arrayFields = [
...
function patchCadenceModern(obj: SummaryRecord): void {
    patchDecimalFields(
        obj,
...
function patchDistance(obj: SummaryRecord): void {
    patchFieldsWithFormatter(
        obj,
...
function patchFieldsWithFormatter(
    obj: SummaryRecord,
    fieldNames: readonly string[],
...
function patchHeartRateModern(obj: SummaryRecord): void {
    patchDecimalFields(
        obj,
...
function patchPowerModern(obj: SummaryRecord): void {
    patchDecimalFields(
        obj,
...
function patchSpeed(obj: SummaryRecord): void {
    patchFieldsWithFormatter(
        obj,
...
function patchTemperatureModern(obj: SummaryRecord): void {
    patchDecimalFields(
        obj,
...
function patchTime(obj: SummaryRecord): void {
    patchFieldsWithFormatter(
        obj,
...
function patchCalories(obj: SummaryRecord): void {
...
function patchDecimals(obj: SummaryRecord): void {
    try {
...
function patchFractionalCadence(obj: SummaryRecord): void {
...
function patchGritFlow(obj: SummaryRecord): void {
...
function patchPCO(obj: SummaryRecord): void {
    const pcoFields = [
        "avg_left_pco",
        "avgLeftPco",
        "avg_right_pco",
...
function patchRespirationRate(obj: SummaryRecord): void {
...
function patchStrokes(obj: SummaryRecord): void {
    const strokeFields = [
        "total_strokes",
        "totalStrokes",
        "avg_stroke_distance",
...
function patchTimestamps(obj: SummaryRecord): void {
...
function patchTorquePedal(obj: SummaryRecord): void {
    const torqueFields = [
...
function patchTrainingLoad(obj: SummaryRecord): void {
