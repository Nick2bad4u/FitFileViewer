...
export function createUserDeviceInfoBox(container) {
    try {
        ...
        // Import theme utilities if available
        let themeConfig;
        ...
        infoBox.style.cssText = `
            ...
            box-shadow: 0 4px 20px rgba(0,0,0,${themeConfig.isDark ? "0.4" : "0.1"}), 
                        0 2px 8px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.1);
        ...
        infoBox.addEventListener("mouseenter", () => {
            ...
            infoBox.style.boxShadow = `0 8px 40px rgba(0,0,0,${themeConfig.isDark ? "0.5" : "0.15"}), 
                                       0 4px 16px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.2)`;
            infoBox.style.borderColor = themeConfig.colors.primary;
        });

        infoBox.addEventListener("mouseleave", () => {
            infoBox.style.transform = "translateY(0) scale(1)";
            infoBox.style.boxShadow = `0 4px 20px rgba(0,0,0,${themeConfig.isDark ? "0.4" : "0.1"}), 
                                       0 2px 8px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.1)`;
        ...
        userSection.addEventListener("mouseenter", () => {
            ...
            userSection.style.boxShadow = `0 6px 20px rgba(0,0,0,${themeConfig.isDark ? "0.3" : "0.1"})`;
        ...
        userSection.innerHTML = `
            <h3 style="margin: 0 0 20px 0; color: ${themeConfig.colors.text}; font-size: 18px; font-weight: 700; border-bottom: 3px solid ${themeConfig.colors.primary}; padding-bottom: 12px; display: flex; align-items: center; gap: 10px; background: linear-gradient(135deg, ${themeConfig.colors.primary}, ${themeConfig.colors.accent}); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                <span style="font-size: 20px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));"></span> User Profile
            </h3>
        ...
        deviceSection.addEventListener("mouseenter", () => {
            ...
            deviceSection.style.boxShadow = `0 6px 20px rgba(0,0,0,${themeConfig.isDark ? "0.3" : "0.1"})`;
        ...
        let deviceHtml = `
            <h3 style="margin: 0 0 20px 0; color: ${themeConfig.colors.text}; font-size: 18px; font-weight: 700; border-bottom: 3px solid ${themeConfig.colors.primary}; padding-bottom: 12px; display: flex; align-items: center; gap: 10px; background: linear-gradient(135deg, ${themeConfig.colors.primary}, ${themeConfig.colors.accent}); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                <span style="font-size: 20px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));"></span> Device Information
            </h3>
        `;

        if (primaryDevice) {
            deviceHtml += `
                <div style="margin-bottom: 20px; padding: 16px; background: linear-gradient(135deg, ${themeConfig.colors.surfaceSecondary}, ${themeConfig.colors.surface}); border-radius: 12px; border: 2px solid ${themeConfig.colors.border}; transition: all 0.3s ease; position: relative; overflow: hidden;" onmouseenter="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,${themeConfig.isDark ? "0.4" : "0.15"})'; this.style.borderColor='${themeConfig.colors.primary}'" onmouseleave="this.style.transform='translateY(0)'; this.style.boxShadow='none'; this.style.borderColor='${themeConfig.colors.border}'">
                    <div style="font-weight: 700; margin-bottom: 12px; color: ${themeConfig.colors.text}; font-size: 16px; display: flex; align-items: center; gap: 8px;">
                        <span style="background: ${themeConfig.colors.primary}; color: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; font-size: 12px;">⭐</span>
                        Primary Device
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; font-size: 14px; color: ${themeConfig.colors.text};">
                        ...
                        ${primaryDevice.garminProduct ? `<div style="padding: 10px; border-radius: 8px; background: ${themeConfig.colors.surface}; border-left: 4px solid ${themeConfig.colors.primary}; transition: all 0.2s ease;" onmouseenter="this.style.transform='translateX(4px)'; this.style.backgroundColor='${themeConfig.colors.accent}'" onmouseleave="this.style.transform='translateX(0)'; this.style.backgroundColor='${themeConfig.colors.surface}'"><strong style="color: ${themeConfig.colors.primary};">Model:</strong> ${primaryDevice.garminProduct}</div>` : ""}
            ...
            deviceHtml += `
                <div>
                    <div style="font-weight: 700; margin-bottom: 16px; color: ${themeConfig.colors.text}; font-size: 16px; display: flex; align-items: center; gap: 8px;">
                        <span style="background: ${themeConfig.colors.accent}; color: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; font-size: 12px;">🔗</span>
                        Connected Sensors
                    </div>
                ...
                if (sensor.manufacturer || sensor.garminProduct) {
                    deviceHtml += `
                        <div style="
                            ...
                            box-shadow: 0 4px 15px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.3);
                        ...
                        onmouseenter="
                            ...
                            this.style.boxShadow='0 8px 25px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.5)';
                            this.style.background='linear-gradient(135deg, ${themeConfig.colors.accent}, ${themeConfig.colors.primary})';
                        " 
                        onmouseleave="
                            this.style.transform='translateY(0) scale(1)'; 
                            this.style.boxShadow='0 4px 15px rgba(${themeConfig.isDark ? "59, 130, 246" : "37, 99, 235"}, 0.3)';
