...
export function createEnhancedChart(canvas, options) {
	const {
		field, chartData, chartType, interpolation, animationStyle, showGrid, showLegend, showTitle, showPoints, showFill, smoothing, customColors, zoomPluginConfig, fieldLabels, theme
	} = options; try {
