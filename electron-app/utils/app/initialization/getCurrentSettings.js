/**
 * @file Chart settings management utility for FitFileViewer
 *
 *   Provides functions for getting, setting, and resetting chart configuration
 *   settings. Handles centralized settings persistence and UI synchronization
 *   for chart options including toggles, selects, ranges, and color settings.
 *
