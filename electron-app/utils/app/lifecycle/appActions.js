 ...
 *
 * @property {any} datasets - Underlying chart dataset collection (library
 *   specific)
...
export const AppActions = {
    ...
    async loadFile(fileData, filePath) {
        const manager =
            fitFileStateManager &&
            typeof fitFileStateManager.handleFileLoaded === "function"
                ? fitFileStateManager
                : null;
...
export class StateMiddleware {
     ...
     *
     * @returns {any} Potentially modified value
     */
    /**
     * @param {string} path
     * @param {any} value
 ...
 * @param {string[]} dependencies - Array of state paths to watch
 *
 ...
 * @param {any} defaultValue - Default value if state is undefined
 *
 * @returns {Array | undefined} Value, setter tuple
 */
/**
...
export function useState(path, defaultValue) {
    ...
    return /** @type {[any, (newValue: any) => void]} */ ([
        currentValue,
        setter,
    ]);
}
