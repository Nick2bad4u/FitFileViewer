"use strict";
{
    ...
    /**
     * Asserts that a FIT file byte length is finite, non-negative, and below
     * the main-process file read cap.
     *
     ...
     */
    function assertFitFileByteLength(byteLength) {
    ...
    function isArrayBufferViewWithArrayBuffer(value) {
        return (
            typeof value === "object" &&
            value !== null &&
     ...
     *
     * @throws Error when the file read result is not binary data or exceeds the
     *   FIT file cap.
     */
    function normalizeFileReadResultToArrayBuffer(value) {
