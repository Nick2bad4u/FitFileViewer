 ...
 */
export function getManufacturerAndProduct(manufacturerId: number | string, productId?: number | string | null): Object;
/**
 ...
 */
export function getManufacturerIdFromName(manufacturerName: string): number | null;
/**
