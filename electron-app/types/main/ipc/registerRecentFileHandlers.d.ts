export function registerRecentFileHandlers(options: any): void;
/**
 ...
 */
export function wireRecentFileHandlers({ registerIpcHandle, addRecentFile, loadRecentFiles, browserWindowRef, mainWindow, getThemeFromRenderer, safeCreateAppMenu, getAppState, logWithContext, }?: {
