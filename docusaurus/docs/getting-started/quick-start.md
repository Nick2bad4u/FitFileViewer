...
After [installing FitFileViewer](/docs/getting-started/installation), launch it from:
...
![Map View](/img/screenshots/map-view.svg)
...
Click the theme toggle (☀️/🌙) in the top-right to switch between light and dark modes.
...
- **[Map Features](/docs/visualization/maps)** - Learn about all map capabilities
- **[Chart Analysis](/docs/visualization/charts)** - Deep dive into chart features
- **[Data Tables](/docs/visualization/tables)** - Master the data table view
- **[Export Options](/docs/user-guide/export-sharing)** - Export your data
...
2. **Use Sample Files**: Check the [fit-test-files folder](https://github.com/Nick2bad4u/FitFileViewer/tree/main/fit-test-files) in the repository
3. **Record a New Activity**: Use your fitness device to record an activity

---

**Need Help?** Check the [Troubleshooting Guide](/docs/user-guide/troubleshooting) or [Report an Issue](https://github.com/Nick2bad4u/FitFileViewer/issues)
