...
import * as preloadClipboardModuleLoader from "../../../electron-app/preload/preloadClipboardModuleLoader.js";
import * as preloadDeveloperApiDomain from "../../../electron-app/preload/developerApiDomain.js";
import * as preloadDeveloperModuleLoader from "../../../electron-app/preload/preloadDeveloperModuleLoader.js";
...
import * as preloadExternalModuleLoader from "../../../electron-app/preload/preloadExternalModuleLoader.js";
...
import * as preloadLifecycleModuleLoader from "../../../electron-app/preload/preloadLifecycleModuleLoader.js";
...
import * as preloadSystemModuleLoader from "../../../electron-app/preload/preloadSystemModuleLoader.js";
...
export function resolvePreloadScriptRequire(
    ...
    if (moduleName === "./preload/preloadClipboardModuleLoader.js") {
        return preloadClipboardModuleLoader;
    }

    if (moduleName === "./preload/preloadDeveloperModuleLoader.js") {
        return preloadDeveloperModuleLoader;
    }

    if (moduleName === "./preload/preloadExternalModuleLoader.js") {
        return preloadExternalModuleLoader;
    }

    if (moduleName === "./preload/preloadLifecycleModuleLoader.js") {
        return preloadLifecycleModuleLoader;
    }

    if (moduleName === "./preload/preloadSystemModuleLoader.js") {
        return preloadSystemModuleLoader;
    }
