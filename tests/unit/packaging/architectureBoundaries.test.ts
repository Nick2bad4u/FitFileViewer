...
const retiredRendererAmbientGlobalPattern =
    /\b(?:aboutModalDevHelpers|closeKeyboardShortcutsModal|devCleanup|dragDropHandler|enableDragAndDrop|injectMenu|mapMarkerCount|screenfull|showKeyboardShortcutsModal)\?:/u;
