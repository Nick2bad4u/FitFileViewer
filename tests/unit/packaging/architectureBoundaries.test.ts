...
const retiredRendererAmbientGlobalPattern =
    /\b(?:_mapThemeListener|aboutModalDevHelpers|clearZoneColorData|closeKeyboardShortcutsModal|devCleanup|dragDropHandler|enableDragAndDrop|injectMenu|mapMarkerCount|resetAllSettings|screenfull|showKeyboardShortcutsModal|updateInlineZoneColorSelectors|updateMapTheme)\?:/u;
