...
const retiredRendererAmbientGlobalPattern =
    /\b(?:_mapThemeListener|aboutModalDevHelpers|ChartUpdater|chartUpdater|clearZoneColorData|closeKeyboardShortcutsModal|createTables|devCleanup|dragDropHandler|enableDragAndDrop|heartRateZones|injectMenu|mapMarkerCount|powerZones|renderChartJS|renderMap|renderSummary|resetAllSettings|screenfull|showFitData|showKeyboardShortcutsModal|updateInlineZoneColorSelectors|updateMapTheme)\?:/u;
