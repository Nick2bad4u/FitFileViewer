...
import { formatTooltipWithUnits } from "../../../electron-app/utils/formatting/display/formatTooltipWithUnits.js";
...
vi.mock(
    import("../../../electron-app/utils/formatting/converters/convertDistanceUnits.js"),
    () => ({
        DISTANCE_UNITS: {
            FEET: "feet",
...
vi.mock(
    import("../../../electron-app/utils/formatting/converters/convertTemperatureUnits.js"),
    () => ({
        TEMPERATURE_UNITS: {
            CELSIUS: "celsius",
