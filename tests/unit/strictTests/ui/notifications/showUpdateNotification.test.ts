...
describe("showUpdateNotification", () => {
    ...
    it("rejects primitive scoped update APIs without invoking install", async () => {
        expect.assertions(5);
        ...
        showUpdateNotification("Try primitive update", "info", 0, true, {
            electronApiScope,
        });
        getRequiredNotificationButton(
            getNotificationButtons(host),
    ...
    it("rejects array-shaped scoped update APIs without invoking install", async () => {
        expect.assertions(6);
        ...
        Object.assign(arrayShapedApi, { installUpdate });
        ...
        showUpdateNotification("Try array update", "info", 0, true, {
            electronApiScope,
        });
        getRequiredNotificationButton(
            getNotificationButtons(host),
    ...
    it("rejects inaccessible scoped update API install properties without invoking install", async () => {
        expect.assertions(5);
        ...
        const errorSpy = vi
            ...
            .mockImplementation(() => {});
        const getElectronAPI = vi.fn<() => unknown>(() =>
            Object.defineProperty({}, "installUpdate", {
                get() {
                    throw new Error("blocked update property");
                },
            })
        );
        const electronApiScope: RendererElectronApiScope = {
        ...
        showUpdateNotification("Try inaccessible update", "info", 0, true, {
            electronApiScope,
        });
        getRequiredNotificationButton(
            getNotificationButtons(host),
